...
export function StatisticsStrip() {
  ...
  const stats = [
    { icon: <FileCheck size={40} />, endValue: 500, suffix: "+", label: "Cazuri Analizate" },
    { icon: <Building2 size={40} />, endValue: 4, suffix: "", label: "Spitale Partenere" },
    { icon: <Heart size={40} />, endValue: 98, suffix: "%", label: "Satisfacție Pacienți" },
